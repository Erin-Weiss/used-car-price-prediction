...
ACTIVE_TUNING_ROUND = "round_3"   # or "round_1", "round_2a", "round_2b", or "round_3"
...
TUNING_SEARCH_SPACE = {
    ...
    "round_2b": {
        "notes": "Did not select due to higher performance cost and no meaningful improvement.",
        "d_token": {
            "choices": [96, 128],
            "dtype": "int",
            "selected": 128,
    ...
    "round_3": {
        "num_tokens": {
            "choices": [1, 4],
            "dtype": "int",
            "notes": "experiment to increase numeric token capacity",
        }
    }
}
